...
public class GuiGraphicsExtractorMixin implements CreativeGuiGraphics {
    ...
    @Override
    public void blit(RenderPipeline renderPipeline, Identifier identifier, int x0, int x1, int y0, int y1, float u, float u2, float v, float v2, int color) {
        innerBlit(renderPipeline, identifier, x0, x1, y0, y1, u, u2, v, v2, color);
    }
    
    @Shadow
    public void innerBlit(RenderPipeline renderPipeline, Identifier identifier, int x0, int x1, int y0, int y1, float u, float u2, float v, float v2, int color) {
