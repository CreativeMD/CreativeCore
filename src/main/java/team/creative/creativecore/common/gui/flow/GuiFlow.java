...
public abstract class GuiFlow {
    ...
    public abstract int minHeight(List<GuiChildControl> controls, int spacing);
    
    public abstract int preferredHeight(List<GuiChildControl> controls, int spacing);
    
    public abstract void flowX(List<GuiChildControl> controls, int spacing, Align align, int width, int preferred);
    
    public abstract void flowY(List<GuiChildControl> controls, int spacing, VAlign valign, int height, int preferred);
