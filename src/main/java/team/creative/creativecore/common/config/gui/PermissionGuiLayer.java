...
public class PermissionGuiLayer extends GuiLayer {
    ...
    protected void addGroupHeader(boolean defaultCol, PermissionGuiGroup group, String name) {
        ...
        if (defaultCol)
            ...
            col.add(group.combobox = (GuiComboBox<String>) new GuiComboBox<String>("name", new TextMapBuilder<String>().addComponent(CreativeCore.CONFIG.usergroups.keySet(),
