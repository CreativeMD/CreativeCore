...
public class CreativeBakedModel implements BakedModel {
    ...
    @Override
    public @NotNull List<BakedQuad> getQuads(@Nullable BlockState state, @Nullable Direction side, @Nonnull Random rand, @Nonnull IModelData data) {
        return get().getQuads(state, side, rand, data);
    }
    ...
    public BakedModel handlePerspective(TransformType transformType, PoseStack poseStack) {
        ...
        return BakedModel.super.handlePerspective(transformType, poseStack);
    }
