...
public class GuiRenderHelper {
    ...
    public static void drawStringCentered(PoseStack stack, String text, float width, float height, int color) {
        drawStringCentered(stack, text, 1.0f, width, height, color);
    }
    
    public static void drawStringCentered(PoseStack stack, String text, float scale, float width, float height, int color) {
        ...
        mc.font.drawShadow(stack, text, width / 2 - (float) mc.font.width(text) / 2, height / 2 - (float) mc.font.lineHeight / 2, color);
    }
