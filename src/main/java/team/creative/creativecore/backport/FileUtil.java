    ...
    public static DataResult<List<String>> decomposePath(String pPath) {
        ...
        if (i == -1) {
            ...
            switch (pPath) {
                ...
                case ".":
                case "..":
                    dataresult = DataResult.error("Invalid path '" + pPath + "'");
                    break;
                default:
                    dataresult = !isValidStrictPathSegment(pPath) ? DataResult.error("Invalid path '" + pPath + "'") : DataResult.success(List.of(pPath));
            }
