...
public abstract class CallHandler {
	...
	/**
	 * This method is used to add an instance of a Class which should be called on
	 * eventRaise. Its called from
	...
	/**
	 * This method is used to remove an EventListner (Class object / Class
	 * instance). Its called from {@link EventBus#removeEventListener(Object)}.
	 * 
	 * @param Listener
	 */
