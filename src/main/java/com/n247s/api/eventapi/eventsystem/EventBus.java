...
public class EventBus {
	 ...
	 *             parameter, or if the parameter of that method is not an instance
	 *             of EventType.class.
	 */
	 ...
	 *             - if the EventListner isn't registered.
	 */
	 ...
	 *         if no CallHanlder is assigned, a default instance is returned!
	 */
