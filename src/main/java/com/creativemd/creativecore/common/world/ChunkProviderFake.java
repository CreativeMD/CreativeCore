...
public class ChunkProviderFake implements IChunkProvider {
	...
	public Chunk loadChunk(int x, int z, Runnable runnable) {
		 ...
		 * net.minecraftforge.fml.common.FMLLog.bigWarning("There is an attempt to load a chunk (%d,%d) in dimension %d that is already being loaded. This will cause weird chunk breakages.", x, z,
