...
public class GuiRenderHelper {
    ...
    public static class ExtendedRenderItem extends RenderItem {
        ...
        private static final Method renderItemModelIntoGUI = ReflectionHelper
            .findMethod(RenderItem.class, "renderItemModelIntoGUI", "func_191962_a", ItemStack.class, int.class, int.class, IBakedModel.class);
