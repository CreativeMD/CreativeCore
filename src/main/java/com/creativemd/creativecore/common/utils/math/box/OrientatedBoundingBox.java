...
public class OrientatedBoundingBox extends CreativeAxisAlignedBB {
    ...
    public OrientatedBoundingBox offset(BlockPos pos) {
        return new OrientatedBoundingBox(origin, this.minX + pos.getX(), this.minY + pos.getY(), this.minZ + pos.getZ(), this.maxX + pos.getX(), this.maxY + pos.getY(), this.maxZ + pos
            .getZ());
    }
    ...
    public double calculateDistanceRotated(AxisAlignedBB other, Axis axis, double offset) {
        ...
        Vector2d[] vectors = { new Vector2d(minOne - outerCornerOne, minTwo - outerCornerTwo), new Vector2d(maxOne - outerCornerOne, minTwo - outerCornerTwo),
                new Vector2d(maxOne - outerCornerOne, maxTwo - outerCornerTwo), new Vector2d(minOne - outerCornerOne, maxTwo - outerCornerTwo) };
