...
public class SortingList implements List<InfoStack> {
	 ...
	 * 
	 * @param objects
	 *            the array can either contain a Material, a Block, an Item, an ItemStack or a String for the OreDictionary.
	 */
	 ...
	 * 
	 * @param object
	 *            can either be a Material, a Block, an Item, an ItemStack or a String for the OreDictionary.
	 */
	 ...
	 * 
	 * @param name
	 *            relates to blocks/items which contains this pattern in their name. Example: "axe".
	 */
	 ...
	 * 
	 * @param name
	 *            relates to ore which contains this pattern {@link #OreDictionary OreDictionary}. Examples: "ingot" or "iron".
	 */
	 ...
	 * 
	 * @param name
	 *            relates to all objects which are connected to this ore inside the {@link #OreDictionary OreDictionary}. Example: "ingotIron".
	 */
