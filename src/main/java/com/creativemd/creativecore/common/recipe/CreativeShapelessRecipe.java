...
public class CreativeShapelessRecipe {/* extends CreativeRecipe{
                                       ...
                                       * if(isStackValid(stack, input[i]))
                                       * return i;
                                       * }
                                       * return -1;
                                       * }
                                       * 
                                       * public int getIDList(ArrayList input, ItemStack stack)
                                       * {
                                       * for (int i = 0; i < input.size(); i++) {
                                       * if(isStackValid(stack, input.get(i)))
                                       * return i;
                                       * }
                                       * return -1;
                                       * }
                                       ...
                                       * {
                                       * if(InvWidth * InvHeigt < this.input.length)
                                       * return null;
                                       * 
                                       * ItemStack[] inv = new ItemStack[this.input.length];
                                       * ArrayList tempInput = new ArrayList();
                                       ...
                                       * {
                                       * int id = getID(stack);
                                       * int listID = getIDList(tempInput, stack);
                                       * if(id != -1 && listID != -1)
                                       * {
                                       * inv[id] = stack;
                                       * tempInput.remove(listID);
                                       * }
                                       * else
                                       * return null;
                                       * }
