...
public class OptifineHelper {
    ...
    private static void loadOptifineReflections() {
        try {
            ...
            getCustomizedQuads = ReflectionHelper
                .findMethod(blockModelCustomizer, "getRenderQuads", "getRenderQuads", List.class, IBlockAccess.class, IBlockState.class, BlockPos.class, EnumFacing.class, BlockRenderLayer.class, long.class, renderEnvClass);
            Class customColorsClass = Class.forName("net.optifine.CustomColors");
            getColorMultiplier = ReflectionHelper
                .findMethod(customColorsClass, "getColorMultiplier", "getColorMultiplier", BakedQuad.class, IBlockState.class, IBlockAccess.class, BlockPos.class, renderEnvClass);
    ...
    public static boolean isAnisotropicFiltering() {
        try {
            return (boolean) isAnisotropicFiltering.invoke(null);
        } catch (IllegalAccessException | IllegalArgumentException | InvocationTargetException e) {
            e.printStackTrace();
        }
        return false;
